...
class affiliate_link:
    ...
    def route(self, code, eventname, result):
        ...
        time.sleep(2)
        module_other_app.write_result_not_displayed_try(code, eventname, result, "Giám sát - đi tới link liên kết click vào xe",
                                                var_app.check_route, "_GiamSat_LoTrinh.png")
